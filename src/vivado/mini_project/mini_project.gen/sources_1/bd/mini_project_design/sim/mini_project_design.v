...
//Date        : Tue Dec  5 17:02:05 2023
//Host        : oliver-pc running 64-bit Ubuntu 20.04.6 LTS
//Command     : generate_target mini_project_design.bd
//Design      : mini_project_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mini_project_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mini_project_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_bram_cntlr_cnt=2,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mini_project_design.hwdef" *) 
module mini_project_design
   (led_ctrl1_1,
    led_ctrl2_1,
    led_ctrl3_1,
    led_ctrl4_1);
  ...
  assign led_ctrl1_1 = nn_ctrl_0_led_ctrl1;
  assign led_ctrl2_1 = nn_ctrl_0_led_ctrl2;
  assign led_ctrl3_1 = nn_ctrl_0_led_ctrl3;
  assign led_ctrl4_1 = nn_ctrl_0_led_ctrl4;
  mini_project_design_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  mini_project_design_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
  ...
  mini_project_design_axi_smc_0 axi_smc
  ...
  mini_project_design_fix_address_0_2 fix_address_0
       (.addr_in(nn_inference_0_input_img_address0),
        .addr_out(fix_address_0_addr_out));
  mini_project_design_nn_ctrl_0_5 nn_ctrl_0
       (.ap_done(nn_inference_0_ap_done),
        ...
        .rstb_busy(axi_bram_ctrl_0_bram_rstb_busy));
  mini_project_design_nn_inference_0_0 nn_inference_0
  ...
  mini_project_design_not_gate_0_2 not_gate_0
       (.i_in(nn_ctrl_0_ap_rst),
        .o_out(not_gate_0_o_out));
  mini_project_design_rst_ps8_0_100M_0 rst_ps8_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  mini_project_design_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
